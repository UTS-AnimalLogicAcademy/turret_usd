...
variants = [
    ...
    ['platform-linux', 'arch-x86_64', 'boost_katana-1.70', 'katana-4.5.2', 'tbb_katana-2019.6', '!nuke'], # usd_katana-21.05 katana 4.5
    ...
    #['platform-linux', 'arch-x86_64', 'usd-20.11', 'tbb-2020.3', 'boost-1.76', '!katana'], # usd-20.11, maya-2023
