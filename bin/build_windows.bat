...
cmake -DUSD_LIB_VARIANT:STRING=%USD_LIB_VARIANT% -DZeroMQ_LIBRARY:STRING=%LIBZMQ_LIB_DIR% -DPC_LIBZMQ_INCLUDE_DIRS:STRING=%LIBZMQ_INCLUDE_DIR% -DCMAKE_INSTALL_PREFIX="C:\Users\142738\software\turret-usd" -G "Visual Studio 14 2015 Win64" ..
